...
- Self-service Purchase is responsible for our primary e-commerce experience, with the goal of increasing the number of first-orders we receive through our self-service purchase flow. 
- Billing & Subscription Management is responsible for experiences to manage an existing subscription, including the purchase of seat add-ons, automated seat reconciliation, and renewals. 
- Provision is responsible for the licensing and paid feature activation for both SaaS and Self-Managed subscriptions. 
- Utilization is responsible for customer facing usage reporting, usage admin controls, and internal billing and support admin tools. 
...
We collaborate frequently across all of GitLab to achieve our goals. Most commonly we work with [Field Operations](/handbook/sales/field-operations/), [Enterprise Applications](/handbook/business-technology/enterprise-applications/), [Growth](/direction/growth/), and [Data](/handbook/business-technology/data-team/) teams.
...
1. [Improve accuracy of determining subscription state using the Zuora Subscription API](https://gitlab.com/groups/gitlab-org/-/epics/8402)
...
In FY23, we are focused on continuing to increase adoption of Cloud Licensing and the switch to strict Cloud Licensing, making Cloud Licensing the default way to activate GitLab self-managed instances. 
...
This means that in every initiative we question the need for complexity. We will strive to build functionality that is easy to understand and use, and make sure it works flawlessly for customers of all types. As much as we can, we won't require a customer to speak to a sales representative and will allow them to choose whether to transact via online self-service tools. 
...
| Initiative                                                           | Team                              |
|----------------------------------------------------------------------|-----------------------------------|
| [Auto-Renewal notification and processing](https://gitlab.com/groups/gitlab-org/-/epics/5619) | Billing & Subscription Management |
| [Align to Zuora Billing Account as a Customer Account](https://gitlab.com/groups/gitlab-org/-/epics/8331) | Fulfillment Platform | 
| Seat Overages Transparency                      | Utilization |
| SaaS Free User Efficiency Program                                         | Purchase, Billing & Subscription Management, Utilization |
| E-Disty Arrow Marketplace Integration                                | Fulfillment Platform, Provision |
| Zuora Ramps deal automated Provision  | Provision | 
