...
canonical_path: "/company/culture/all-remote/collaboration-and-whiteboarding/"
...
1. [Designing in an all-remote company](/blog/2020/03/27/designing-in-an-all-remote-company/)
1. [Improving iteration and collaboration with user stories](/blog/2020/03/27/how-we-utilize-user-stories-as-a-collaborative-design-tool/)
1. [Running an asynchronous sketch workshop for UX](/blog/2020/03/27/async-sketching/)
1. [Synchronous collaboration as a remote designer at GitLab](/blog/2020/04/01/synchronous-collaboration-as-a-remote-designer-at-gitlab/)
...
Remote teams should aim to [minimize their tool stack](/company/culture/all-remote/remote-work-emergency-plan/#minimize-your-tool-stack). It's good practice to consider how you can extract additional value from tools you already use, and [Google Docs](/handbook/communication/#google-docs) is a great example of this. While Google Docs is a fantastic shared editing tool, GitLab also uses it for temporal [meeting documentation](/company/culture/all-remote/meetings/#document-everything-live-yes-everything) (prior to contextualizing takeaways for placement in relevant [handbook](/company/culture/all-remote/handbook-first-documentation/) sections).
...
1. Can make [low-context comments](/company/culture/all-remote/effective-communication/#understanding-low-context-communication) that are time-stamped
...
1. [Inexpensive Active Pen Tablet Setup and Three Whiteboarding Apps](/company/culture/all-remote/collaboration-and-whiteboarding/setups/#samsung-8-active-pen-tablet-with-liveboard-app)
...
Learn more about "the whiteboarding fixation" in our [guide to understanding the phases of remote adaptation](/company/culture/all-remote/phases-of-remote-adaptation/#the-whiteboarding-fixation).

### People planning

<!-- blank line -->
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/xt5cxXBv1-A" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
Remote collaboration starts with people. Creating a [remote culture](/company/culture/all-remote/building-culture/) includes trusting that the people within the company will do their work. [Documentation](/company/culture/all-remote/handbook-first-documentation/) is vital to the independence of employees. This includes documenting everything from company [values](/handbook/values/) to daily [meetings](/company/culture/all-remote/meetings/).
...
The most important aspect of collaboration meetings is to [have an agenda](/company/culture/all-remote/management/#docs-instead-of-whiteboards). Creating an agenda helps to cover everything and sets a plan for the scheduled discussion. It also makes it easier for those who didn't attend to feel included by having a document they can review after the meeting. Not everyone will always be in the meeting, but they can stay up-to-date as long as the meeting is documented, [encouraging clear communication](/blog/2019/12/23/six-key-practices-that-improve-communication/). Google Docs is a collaborative, real-time tool to take notes, share decisions, and keep all stakeholders informed.

Most design discussions and decisions at GitLab are created and worked in [GitLab Issues](/company/culture/all-remote/gitlab-for-remote/). Recently, [Design Management](https://docs.gitlab.com/ee/user/project/issues/design_management.html) was released in order for designers to upload images and make comments in the same platform that Product Managers and Developers use.
...
### Company handbook
At GitLab, we believe that "everyone can contribute." The company handbook is where everything is documented — our [single source of truth](/company/culture/all-remote/handbook-first-documentation/#terminology-documentation-handbook-first-single-source-of-truth) — specifically laying out the six core [values](/handbook/values/) of the company. The handbook deliberately and intentionally describes each group's role within the company, including how the [UX teams](/handbook/product/ux/product-designer/) researches, designs and writes about the product.

### Iterate and iterate some more
Since the inception of GitLab, [iteration](/blog/2020/02/04/power-of-iteration/) has been one of six core values and steers the creation of product development. Making many small changes has been a way to make improvements faster.
...
### Pinging on Slack
Slack is generally accepted as an [informal method of communication](/company/culture/all-remote/how-to-work-remote-first/#expire-your-slack-or-teams-messages-after-90-days). Slack channels can be created easily for various groups or individuals. If there are questions or comments that require a quick response, Slack is the best way to get in touch with a co-worker. Slack is a fast way to collaborate on a topic without having to schedule a meeting in advance.

> “Pinging someone on slack is like bumping into them in the hallway,” — *Alexis Ginsberg, Senior Product Designer at GitLab*

## Synchronous collaboration

Synchronous work within a standard organization makes sense. Work starts and ends when people enter and leave the office. Meetings happen all together in some version of a boardroom. However, when co-workers are spread throughout the world, [sync collaboration](/blog/2020/04/01/synchronous-collaboration-as-a-remote-designer-at-gitlab/) can be a bit more challenging. Here are some ways that GitLab has been able to establish a level of normalcy regardless of what time zone people are in.
