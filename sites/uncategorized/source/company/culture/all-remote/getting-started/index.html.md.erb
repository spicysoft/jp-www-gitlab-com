...
canonical_path: "/company/culture/all-remote/getting-started/"
...
In an [all-remote](/company/culture/all-remote/hybrid-remote/#all-remote-upgrade) organization, each individual is empowered to [work and live](/company/culture/all-remote/people/) where they are most fulfilled. A remote job allows you to work from wherever you're most comfortable. That could be a coffee shop, your basement office, a coworking space, or even a different place every month!

## During the interview phase, get an understanding of how the company defines remote work.

Different companies will have [different approaches to remote work](/company/culture/all-remote/phases-of-remote-adaptation/). Make sure you understand what your work environment will be like, and whether it matches your own working style.
...
Another element to flesh out during an interview is remote communication. GitLab is an [asynchronous](/company/culture/all-remote/asynchronous/) company. Much of what we do is [communicated through text](/company/culture/all-remote/effective-communication/). For people used to working in-office and default to verbal communication, it may take some time to transition to communicating information via text.

## Prepare for a different type of onboarding
Being [stressed about learning a new job](http://www.classycareergirl.com/2017/02/new-job-anxiety-conquer/) is a reality for many people. Remote onboarding for new GitLab team-members may be new as they join our [all-remote](/company/culture/all-remote/) culture. Prepare yourself to be flexible, open, and ready to listen, learn, research, try new things, and get comfortable with videos and video calls for your onboarding process.

## How do I prepare for the first day of remote work?
For those who have not worked in a [remote organization](/company/culture/all-remote/) before, you may want help thinking through an ideal [workspace](/company/culture/all-remote/workspace/) and need a few tips and tricks for [informal communication](/company/culture/all-remote/informal-communication/). Make sure your technology and internet are all working and connected and be ready to introduce yourself, take notes, and ask questions. 
...
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/7kMQj4O4ZGU" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
This tends to be [particularly vital to discuss with children](/blog/2019/08/01/working-remotely-with-children-at-home/), who may struggle to understand why a working parent is in the home but are unable or unwilling to engage with them for certain parts of the day. 
...
Below are a number of intentional facets of [GitLab's culture](/company/culture/#culture-at-gitlab), created to foster connections. 
...
If you worked at an office before, you might miss interacting with your coworkers at lunch or in the office hallways. In a remote environment, you need to [be more intentional about connecting with coworkers](/company/culture/all-remote/informal-communication/#formally-design-informal-communications). Make time for coffee chats, reach out to teammates, and share details of your life to help people get to know you.

### Set up work-life boundaries
Be intentional about planning your [time off](/handbook/paid-time-off/).
When you're not working, disconnect by turning off Slack and closing down your email client. At GitLab, this only works if all team members abide by the [communication guidelines](/blog/2016/03/23/remote-communication/#asynchronous-communication-so-everyone-can-focus). It also helps to enable the "working hours" feature on your calendar so that team members in other time zones know when to schedule meetings.

### Get accustomed to the communication preferences of your co-workers
GitLab encourages [non-work related communication](/company/culture/all-remote/informal-communication/) (talking about private life on a team call) for [relationship building](https://medium.com/@markfrein70/the-distributed-workplace-15ef447fa926). Take advantage of group video calls for [bonding](/blog/2015/04/08/the-remote-manifesto/), one-on-one [video calls](/blog/2015/04/08/the-remote-manifesto/) between people (as part of onboarding), and be sure to attend [periodic summits](/events/gitlab-contribute/) with the whole company to get to know each other in an informal setting.
...
It's important to pay close attention to your [mental health](/company/culture/all-remote/mental-health/) and [emotional health](/blog/2018/03/08/preventing-burnout/) as you transition to a remote role. If you sense a void from missing out on face-to-face interaction, act deliberately and early. 
...
For GitLab team members, be sure to join the `#mental_health_aware` Slack channel and read our [guide](/company/culture/all-remote/mental-health/) on combating burnout, isolation, and anxiety in the remote workplace. 
...
We've created this [extensive list of resources for remote professionals, teams, and organizations](/company/culture/all-remote/resources/).
