...
canonical_path: "/company/culture/all-remote/self-service/"
...
All-remote companies such as GitLab thrive through [documentation](/company/culture/all-remote/management/#scaling-by-documenting). Crucially, this requires every team member to be equally invested in perpetuating documentation, creating a virtuous cycle of self-searching, self-service, and self-learning. 
...
From the [very first day at GitLab](/company/culture/all-remote/getting-started/), it is imperative that new team members operate with the assumption that their questions are already answered. This is a profound process shift that may feel unnatural and inefficient. 
...
This way of working permeates the GitLab [culture](/company/culture/all-remote/values/), from a bias towards [asynchronous communication](/company/culture/all-remote/management/#asynchronous), to maintaining a [low level of shame](/handbook/values/#low-level-of-shame), to [being deliberate about scale](/handbook/values/#be-deliberate-about-scale).
...
GitLab's use of [onboarding buddies is well documented](/handbook/people-group/general-onboarding/onboarding-buddies/). To provide context on how new team members can shape the future for colleagues to come by [focusing on improvement](/handbook/values/#focus-on-improvement), an example is showcased below.

1. An onboarding buddy asked a new hire what [feedback](/company/culture/all-remote/effective-communication/#feedback-is-a-gift) she had after two weeks of onboarding.
...
Humans tend to trust other humans more than words written in an online repository, which is why it's so vital to humanize a handbook by empowering [all members of a company to contribute](/company/strategy/#why). 
...
![GitLab customer path illustration](/images/all-remote/gitlab-customer-path.jpg){: .medium.center}
...
1. Making your day more efficient, enabling you to disengage with work earlier and [enjoy your surroundings](/company/culture/all-remote/people/), family, and community. 
1. Allowing the recipient to ingest the answer [on their own time](/company/culture/all-remote/management/#asynchronous).
1. Removing bias from the answer, which empowers the recipient to [iterate further](/company/culture/all-remote/management/#applying-iteration-to-everything) on what is documented by starting a [merge request](/blog/2019/08/02/gitlab-for-the-non-technical/). 
...
![GitLab journey path illustration](/images/all-remote/gitlab-journey-and-navigation.jpg){: .medium.center}
...
Complete all knowledge assessments in the [Remote Work Foundation](/company/culture/all-remote/remote-certification/), to receive the [Remote Foundations Badge in GitLab Learn](https://gitlab.edcast.com/pathways/copy-of-remote-foundations-badge) If you have questions, please reach out to our [Learning & Development team](/handbook/people-group/learning-and-development/) at `learning@gitlab.com`.
