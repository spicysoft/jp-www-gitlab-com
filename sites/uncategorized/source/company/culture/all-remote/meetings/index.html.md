...
### 1. Make meeting attendance optional {#1-make-meeting-attendance-optional}
...
#### Record meetings to encourage async participation {#record-meetings-to-encourage-async-participation}
...
#### Managing meeting attendance for team members {#managing-meeting-attendance-for-team-members}
...
### 2. Cancel unnecessary meetings {#2-cancel-unnecessary-meetings}
...
### 4. All meetings must have an agenda {#4-all-meetings-must-have-an-agenda}
...
### 5. Document everything live (yes, everything) {#5-document-everything-live-(yes,-everything}
...
### 6. Use the right tools {#6-use-the-right-tools}
...
#### Use GitLab to replace meetings {#use-gitlab-to-replace-meetings}
...
### 7. Avoid hybrid calls {#7-avoid-hybrid-calls}
...
### 8. Meetings are about the work, not the background {#8-meetings-are-about-the-work-not-the-background}
...
### 9. It's OK to look away {#9-its-ok-to-look-away}
...
### 10. Say thanks and be creative {#10-say-thanks-and-be-creative}
...
## Remote meeting FAQ's {#remote-meeting-faqs}### What are the benefits of a remote meeting? {#what-are-the-benefits-of-a-remote-meeting}
...
### What are the challenges of a remote meeting? {#what-are-the-challenges-of-a-remote-meeting}
...
### How can I prepare for a remote meeting? {#how-can-i-prepare-for-a-remote-meeting}
...
### What should I do after a remote meeting? {#what-should-i-do-after-a-remote-meeting}
...
### How can I improve my remote meeting skills? {#how-can-i-improve-my-remote-meeting-skills}
...
### What are "All-remote Virtual 'Offsites'"? {#what-are-all-remote-virtual-'offsites'"}
...
### How do I run a remote board meeting? {#how-do-i-run-a-remote-board-meeting}
...
### What is the difference between remote and in-person meetings? {#what-is-the-difference-between-remote-and-in-person-meetings}
...
### Who should be invited to meetings? {#who-should-be-invited-to-meetings}
...
### How do you enable folks who don't attend meetings in-person to effectively participate? {#how-do-you-enable-folks-who-dont-attend-meetings-in-person-to-effectively-participate}
...
### How do you create a low meeting culture? {#how-do-you-create-a-low-meeting-culture}
...
### How do you keep participants engaged in a remote meeting? {#how-do-you-keep-participants-engaged-in-a-remote-meeting}
...
### What are the best alternatives to Zoom for remote meetings? {#what-are-the-best-alternatives-to-zoom-for-remote-meetings}
...
## A Conversation with Sid on Meeting preparation and efficiency {#a-conversation-with-sid-on-meeting-preparation-and-efficiency}
...
## GitLab Knowledge Assessment: All-Remote Meetings {#gitlab-knowledge-assessment-all-remote-meetings}
