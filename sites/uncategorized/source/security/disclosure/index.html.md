...
description: " Responsible Disclosure Policy - reporting any security vulnerabilities in GitLab or in a project hosted on GitLab.com"
...
You can find details on how we handle [security releases here](https://gitlab.com/gitlab-org/release/docs/blob/master/general/security/process.md). On our website you can also find more about [the availability and security of GitLab.com](/gitlab-com/#faq).
