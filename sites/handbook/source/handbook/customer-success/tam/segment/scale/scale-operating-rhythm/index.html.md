...
1. Once the call is complete, the call must be [logged as an activity](/handbook/customer-success/tam/cadence-calls/#review-and-update-account-details) against the customer’s timeline in Gainsight. 
...
When a CSE has accepted a Scale CSE engagement request, the CSE must then create a [CTA](/handbook/customer-success/tam/gainsight/ctas/) in Gainsight for proper tracking and CSAT survey deployment post-follow-up email.
