...
1. `Are there other stakeholders to involve?` Is there anyone else who would benefit from having business discussions with GitLab? CSMs should always have at least 2 regular contacts they speak with, ideally in line with our [target personas](/handbook/customer-success/tam/engagement/#customer-personas).
...
The first [cadence call](/handbook/customer-success/tam/cadence-calls/) is typically the CSM's second conversation with the customer and when we start to deliver value through our efforts as a trusted advisor.
...
- Update timeline entry, with a [revised CSM Sentiment](/handbook/customer-success/tam/health-score-triage/#health-assessment-guidelines)
...
- Add an Update timeline entry with [updated CSM Sentiment](/handbook/customer-success/tam/health-score-triage/#health-assessment-guidelines)
...
[CSM-assigned accounts](https://about.gitlab.com/handbook/customer-success/tam/services/): When a customer signs at or reaches the CSM-assigned threshold, a [Call To Action (CTA)](/handbook/customer-success/tam/gainsight/ctas/) is triggered within Gainsight.
