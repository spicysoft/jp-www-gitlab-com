...
* More closely tied to [problem validation](/handbook/product/ux/ux-research-training/problem-validation-and-methods/) than [solution validation](/handbook/product/ux/ux-research-training/solution-validation-and-methods/)
...
**What it is NOT:**
* [Solution validation](/handbook/product/ux/ux-research-training/solution-validation-and-methods/)
* Specific to a single stage group (in most cases)
* [Problem validation](/handbook/product/ux/ux-research-training/problem-validation-and-methods/) research tied to a specific issue/feature
...
* Creating [Actionable Insights](/handbook/product/ux/ux-research-training/research-insights/) connected to cross-stage group issues to be scheduled in the next 1 year 
