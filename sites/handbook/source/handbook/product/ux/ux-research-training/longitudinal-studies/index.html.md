...
1. [Open a recruitment issue](/handbook/product/ux/ux-research-training/recruiting-participants/#open-a-recruitment-request-issue) that outlines the number of touchpoints and time commitment for each one.
