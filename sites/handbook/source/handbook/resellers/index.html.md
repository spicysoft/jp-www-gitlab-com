...
This page provides an overview of the Channel program, requirements, benefits, and instructions. Additional information about our services program and certifications can be found on the following pages:

* [Channel Services Program Guide Program](/handbook/resellers/services/)
* [Channel Services Catalog](/handbook/resellers/services/)
* [Channel Services Services Catalog](/handbook/resellers/services/services-catalog/)
* [Channel Partner Training and Certifications](/handbook/resellers/training/)
* [Working with GitLab](/handbook/resellers/working-with-gitlab/)
* [Tools and Resources](/handbook/resellers/partner-tools-resources/)

For information about our Alliance Partner program, please visit the [Alliances handbook page.](https://about.gitlab.com/partners/technology-partners/)
...
To engage with GitLab, partners start by completing the online Channel Partner registration process on [partners.gitlab.com](partners.gitlab.com), which leads partners through executing the GitLab Partner Agreement and obtain  access to our Partner Portal where partners complete their onboarding.

<<<<<<< sites/handbook/source/handbook/resellers/index.html.md
...
*   **Partner Sourced/Initiated Discount** - You can earn the largest available product discount with a **Partner Sourced opportunity**. A Partner Sourced opportunity is a new opportunity to our sales team, and can be for a new or existing customer.  The Partner Sourced discount is an up front discount. The partner is expected to assist the GitLab Sales team in closing the sale.  To qualify for a Sourced discount, partners must submit a deal registration to GitLab via the GitLab Partner Portal, and it must be approved by GitLab Sales to qualify. Partner Sourced is available for both resale and referral opportunities.  Partners purchasing GitLab for their own internal production use and add-on licenses at renewal can also qualify for a Partner Sourced discounts, however they must first meet all program requirement for their specific program track (Open or Select).  Please visit the Deal Registration Program guideline in the Program Guide for additional details.
...
GitLab Select partners have access to the proposal-based GitLab Marketing Development Funds (MDF) Program. The MDF funds provide funding support for eligible marketing and partner enablement activities that help to:
...
* **To receive MDF, you must:**
  ...
  *  Promptly submit the required **invoice and proof of performance** documentation to GitLab **30 days following the activity**
