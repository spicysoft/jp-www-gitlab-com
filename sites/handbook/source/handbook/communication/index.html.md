...
[世界のどこから](/jobs/faq/#country-hiring-guidelines)でも働ける[オールリモート](/company/culture/all-remote/#advantages-for-organizations)企業です。どこに住んでいるか関係なく、優秀な人材を採用しています。 [60カ国以上](/company/team/)の人と一緒に働いています。 人と人をつなげて仕事の効率があがるようなわかりやすいコミュニケーションをすることが重要です

そのために, <b>[非同期コミュニケーション](/company/culture/all-remote/asynchronous/)を出発点として</b>、パブリックイッシューや、[マージリクエスト](#everything-starts-with-a-merge-request)や、[Slackチャネル](/handbook/communication/chat/)を活用して、できるかぎりオープンで透明性の高くコミュニケーションをしています。

オフラインでの会話の結論は絶対に文章化してください。もし非同期での会話が**3往復**しても結論が出なかったら、[同期型ビデオ通話](/handbook/communication/#video-calls)に移行してください。

常に敬意を払い、プロフェッショナルとして、コミュニケーションをします。

## 効果的で責任あるコミュニケーションガイドライン {#effective--responsible-communication-guidelines}

1. **[ポジティブな意図](/handbook/values/#collaboration)を想定する。** 常に前向きで優しさのある態度で始める。
1. **親切な対応** 画面と話しているのではなく人と話しているのです。面と向かって言わないようなことは、テキストメッセージでも相手に送らないようにしましょう。
1. **責任を持って発言をする、排他的な発言をしない** みんな住んでいる場所も違うし、考え方も違います。考えていること、意見、そして気持ちを知りたいと思っています。またデリケートな話題に関してはコミュニケーションのガイドラインを考慮してください。
1. **過ちは認める** 言ってしまったこと、送ってしてしまったことは、自分の責任です。わざとではなくても、会社や個人を傷つけた場合は、考え方を改めて、すぐに謝ることをお勧めします。
1. **[バリュー](/handbook/values/)を体現してください**
1. **フィードバックは不可欠です。** チームメンバーは60以上の別な国で働いています。それぞれの国で何が適切なのかを理解することは難しいです。チームメンバーが思いやりをもってフィードバックをすること、そしてフィードバックを受けることを奨励しています。
1. **対面(1on1)を甘く見てはいけない。** 非同期コミュニケーション（例：テキスト）は効果的です。しかし場合によっては（例えば、誤解をとくために）Zoomでビデオ通話をしてみるほうが効果的なこともあります。
1. **[アンチハラスメントポリシー](/handbook/anti-harassment/) と [GitLab ビジネス行動・倫理規範](https://ir.gitlab.com/static-files/7d8c7eb3-cb17-4d68-a607-1b7a1fa1c95d)を常に遵守すること。** 誰もが快適に働ける環境であるべきです。
1. **直接影響を与えることができるものに焦点を当てる。** 直接影響を与えることができないコトはたくさんありますが、そのようなことを議論するのに時間を費やすのは避けるべきでしょう。 例えば、コントロールできるものではないので、[時価総額](/handbook/being-a-public-company/#market-capitalization)を議論することはしません。 代わりに、KPI と [年間経常利益](/handbook/sales/sales-term-glossary/arr-in-practice/)の成長に焦点をあてるべきです.

非同期コミュニケーションを採用して、効果的に活用するためには、マインドチェンジが必要です。対面でのミーティングやコミュニケーションが当たり前なみんなで同じ場所で働く環境から来た人にとっては、これは珍しいことですし不快にさえ感じられるかもしれません。[オールリモート環境でテキストの使用をマスターする方法を学んでください](/company/culture/all-remote/effective-communication/).

## 誰もがモデレーター {#everyone-is-a-moderator}
...
### どのようなリスクがあるか？  {#what-are-the-risks}
...
### どこでコミュニケーションするかを決める {#determining-which-communication-forum-to-use}
...
## 社外とのコミュニケーション {#external-communication}
...
### 有償の外部講演依頼 {#paid-external-speaking-requests}
...
## すべてはMerge Requestから始まる {#everything-starts-with-a-merge-request}
...
### 「マネージャー・メンションMR」 で マージリクエストを大きくする (旧コンソリデーテッドMR) {#scaling-merge-requests-through-manager-mention-mrs-formerly-consolidated-mrs}
...
```
## Manager Mention MR {#manager-mention-mr}
...
## アドバイスとベストプラクティス {#top-tips-and-best-practices}
...
### 全社発表の仕方 {#how-to-make-a-company-wide-announcement}
...
### AMA:なんでも質問会 {#ask-me-anything-meetings}
...
### 会議でのスマートなメモの取り方 {#smart-note-taking-in-meetings}
...
### `#company-fyi`チャンネルに投稿する {#posting-in-company-fyi}
...
#### `#whats-happening-at-gitlab`に投稿する {#posting-in-whats-happening-at-gitlab}
...
### マルチモーダルなコミュニケーション {#multimodal-communication}
...
## ナンバリングは、後から参照しやすくするためであり、重要度ではありません {#numbering-is-for-reference-not-as-a-signal}
...
## 確認したことを返事する (ACK) {#acknowledgement-receipts-ack}
...
## どこに行けばいいのかわからない？ {#not-sure-where-to-go}
...
## ウォーク＆トークコール {#walk-and-talk-calls}
...
## リリース振り返りとキックオフ {#release-retrospectives-and-kickoffs}
...
## ミーティングのスケジューリング {#scheduling-meetings}
...
### ミーティング・クリーンナップデー {#meeting-cleanup-day}
...
### よくある会議の問題点 {#common-meeting-problems}
...
### 会議で発表しない {#no-presenting-in-meetings}
...
## アベイラビリティの表示 {#indicating-availability}
...
### 注意力を管理するのはあなたです {#you-are-the-manager-of-your-attention}
...
### 会議の参加者にホストへ気配りするように求めない {#do-not-ask-meeting-attendees-to-pay-attention}
...
### 最初に投稿する人が最も素晴らしい {#first-post-is-a-badge-of-honor}
...
### 通話を終了する前にカウントダウンをしない {#do-not-do-a-countdown-before-ending-a-call}
...
## ハイブリッド通話は迷惑です {#hybrid-calls-are-annoying}
...
## ユーザーコミュニケーションガイドライン {#user-communication-guidelines}
...
## ライティング・スタイル・ガイドライン {#writing-style-guidelines}
...
## 状況-複雑性-説明-立場-行動-利益 (SCI-PAB®) {#situation-complication-implication-position-action-benefit-sci-pab}
...
### 非効率的なことをポジティブに言ってはいけない {#inefficient-things-shouldnt-sound-positive}
...
#### グループダイレクトメッセージを使用しない {#do-not-use-group-direct-messages}
...
#### DMでないメッセージの割合を追跡する理由 {#why-we-track--of-messages-that-are-not-dms}
...
### パブリックチャンネルを使用する {#use-public-channels}
...
### 自分の時間を大切にする {#be-respectful-of-your-own-time}
...
### Slackで雑音を管理し集中力を高める {#managing-noise-and-creating-focus-in-slack}
...
#### Slackのサイドバーを優先順位で整理する {#organizing-your-slack-sidebar-by-priority}
...
#### Slackの通知を管理する {#manage-your-slack-notifications}
...
#### 通知を確認する時間を確保する {#set-aside-time-to-work-through-notifications}
...
1. Everyone can contribute, and while opinions are important to provide perspective, we value [proposals](/handbook/values/#make-a-proposal) and [iteration](/handbook/values/#iteration). If the subject is of value to the wider community, consider commenting on an existing issue or opening a new [merge request](#everything-starts-with-a-merge-request) instead.
...
### Eグループ(経営幹部)と連絡を取る {#getting-in-touch-with-the-e-group}
...
### 主なSlackチャンネル {#key-slack-channels}
...
### Yerbo Slack アプリ {#yerbo-slack-app}
...
#### Yerboアプリの仕組み {#how-the-yerbo-app-works}
...
### なぜひとつ上にアップグレードするのですか？ {#why-are-we-upgraded-to-the-plus-tier}
...
#### GitLabはどんな時にCorporate Exportを使うのでしょうか？ {#when-would-gitlab-use-corporate-export}
...
#### ダイレクトメッセージやプライベートチャンネルの会話は完全にプライベートなものですか？ {#are-my-direct-messages-and-private-channel-conversations-completely-private}
...
#### Slackに新しいアプリを追加したい時 {#need-to-add-a-new-app-to-slack}
...
#### SlackとZoomがダウンしています {#slack-and-zoom-are-down}
...
### 効果があった実践と役立つヒント {#good-practices--helpful-tips}

-  If you have content in a Google Doc that is later moved to the website or handbook, [deprecate the Google Doc](#how-to-deprecate-a-google-doc).
...
-  If you are having trouble finding a shared Google Doc, make sure you [Search &lt;your domain&gt;](https://support.google.com/a/answer/3187967?hl=en) in Google Drive.
...
-  You can find a template of the [GitLab letterhead](https://docs.google.com/document/d/1gN1Z2FHPIfPk7QLIey1KF9dR1yTl0R7QrMSb5_Iqfh4/edit) on the shared Google Drive. Please be sure to make a copy of the document to your Google Drive before customizing the template for your use.
...
### Google Doc を公開する方法 {#how-to-publish-a-google-doc}
...
### Google Doc を非公開にする方法 {#how-to-deprecate-a-google-doc}
...
## YouTubeへの投稿やストリーミング {#posting-or-streaming-to-youtube}
