...
-   [Buyer personas](https://about.gitlab.com/handbook/marketing/strategic-marketing/roles-personas/buyer-persona/) - Focus on the high-level goals of potential customers who may or may not be potential users. Owned by the Marketing team.
...
2.  Use the[ GitLab team page](https://about.gitlab.com/company/team/), various department team pages (like the [Engineering page](https://about.gitlab.com/handbook/engineering/#engineering-departments-sub-departments--teams)), or put a message in a team's slack channel (usually found near the bottom of a team page) to recruit internal participants for feedback.
    1.  Use a [Calendly link](/handbook/engineering/ux/ux-research-training/recruiting-participants/#create-a-calendly-event) to schedule the 30 minute interview sessions.
...
To kick off participant recruitment, refer to the [UX handbook guide on how to recruit and schedule participants](/handbook/engineering/ux/ux-research-training/recruiting-participants/). Open a recruitment issue and use the screener derived from your previous research [Step 2](#step-2-internal-interviews).  Use the handbook page on [writing screener questions](/handbook/engineering/ux/ux-research-training/write-effective-screener/) for help, if needed.
...
If you are unfamiliar on [Gitlab's JTBD](/handbook/engineering/ux/jobs-to-be-done/), here is a small overview and [guide](/handbook/engineering/ux/jobs-to-be-done/#quick-methods-to-increase-confidence)
...
![PersonaVennDiagram](/handbook/engineering/ux/persona-creation/PersonaVennDiagram.png)
