...
View how we collect [synchronous and asyncrhonous design feedback](/handbook/engineering/ux/product-designer/#design-reviews).
...
Once each quarter, we run a [System Usability Scale (SUS)](/handbook/engineering/ux/performance-indicators/system-usability-scale) survey to measure user perception of the GitLab product. We send the survey to members of the wider GitLab community, with the goal of asking for a response from any individual no more than once per year.
...
* [GitLab First Look](/handbook/engineering/ux/ux-research-coordination/first-look-ux-research-panel)
