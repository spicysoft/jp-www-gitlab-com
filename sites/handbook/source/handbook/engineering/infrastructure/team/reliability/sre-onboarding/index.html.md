...
Releases candidates are deployed to GitLab.com through auto-deployments that occur weekly. For information about how releases at GitLab.com read about [the releases process](/handbook/engineering/releases/#gitlabcom-deployments-process) visit the
