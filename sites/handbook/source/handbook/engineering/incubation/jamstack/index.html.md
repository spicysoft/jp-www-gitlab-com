...
The Jamstack SEG work is guided by a simplified version of the [Category 
Maturity Scorecards](/engineering/ux/category-maturity-scorecards/) process 
to identify work areas and progress. The work is broken down 
into several [Jobs to be done](/engineering/ux/category-maturity-scorecards/#step-0-jobs-to-be-done-jtbd), 
individually rated. These are the tasks that the SEG is working on. This 
...
Maturity: `0%` Status: `work in progress`
