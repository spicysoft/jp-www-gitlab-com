...
[AppSec projects policies]: /handbook/engineering/security/security-engineering-and-research/application-security/inventory.html#policies
...
[Security Requirements for Development and Deployment]: /handbook/engineering/security/planning/security-development-deployment-requirements/
...
- Reference our [GitLab Cryptography Standard](/handbook/engineering/security/cryptographic-standard.html)

<!-- Add FIPS and FedRamp requirements here when available -->

[Do not roll your own crypto]: /handbook/engineering/security/threat-management/vulnerability-management/encryption-policy.html#rolling-your-own-crypto
...
[classified red data]: /handbook/engineering/security/data-classification-standard.html
...
The Security Architecture review process is detailed in this [page](/handbook/engineering/security/architecture/review.html).
