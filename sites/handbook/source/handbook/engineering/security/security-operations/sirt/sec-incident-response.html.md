...
- SIRT determines the incident severity and priority based on the following [incident classification](/handbook/engineering/security/security-operations/sirt/severity-matrix.html) methodology
3. Containment
