...
The team focus for the security research team falls into the two following categories in order to align with the [role description](/handbook/engineering/security/#security-research):
...
- Data access [(red/orange/green)](https://about.gitlab.com/handbook/engineering/security/data-classification-standard.html#data-classification-levels)
