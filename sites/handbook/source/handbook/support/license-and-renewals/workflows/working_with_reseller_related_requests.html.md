...
- Have the current Sold-To contact file a support ticket with us, following the workflow [Add subscription management contact workflow](../customersdot/associating_purchases.html#add-or-change-subscription-management-contact-workflow)
