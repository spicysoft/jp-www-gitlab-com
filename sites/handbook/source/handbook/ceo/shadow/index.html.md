...
title: CEOシャドウ・プログラム
description: "GitLabでは、CEOシャドウというのは役職ではなく、CEOを影で支えるという一時的な任務です"
---
...
GitLabでは、CEOシャドウというのは役職ではなく、CEOの影になるための一時的な任務です。
シャドウは、ローテーションの間、[CEOの全てのミーティング](/handbook/ceo/#ceo-meeting-cadence)に出席します。
GitLabは[オールリモート](/company/culture/all-remote/)の会社ですが、CEOは外部組織との直接のミーティングがあります。
リモートローテション](#remote-shadow-rotations)の期間中に参加しない限り、[ローテション](#rotation-rhythm)の期間中はサンフランシスコに滞在し、CEOと一緒に移動することになるのです。
...
CEOシャドープログラムの目的は、チームメンバーや[有資格者](/handbook/ceo/shadow/#eligibility)に[会社](/company/)のあらゆる面を概観してもらうことです。この透明性により、CEOシャドウの参加者は、部門を超えたより良いエンゲージメントとコラボレーションを実現し、より良い「グローバル最適化」(/handbook/values/#global-optimization)を実行することができます。

CEOシャドーとして、このようなコンテキストを、[ミーティング](#meetings--events)や、全社的な短期的な[タスク](#tasks)を[完了](/handbook/values/#bias-for-action)しながら身につけることができます。
このプログラムでは、CEOが全社的なチームメンバーと関係を築き、課題や機会をより早く発見する機会もつくられます。
また、シャドー同士がつながり、新たな部門横断的な関係を築くことも多いでしょう。
...
CEOシャドウ・プログラムは、業績評価や昇進への次のステップではありません。CEOシャドーであることは、昇進や昇給のために必要ではなく、また、多様な応募者が異なる資格を持っているため、昇進や昇給の検討要素にすべきではない。
...
リーダーシップの機会を創出する以外に、CEOシャドウ・プログラムは以下のようなメリットがあります。

1. 投資家と顧客の双方に好印象を与えることができる
1. CEOにすぐにフィードバックができる
1. CEO がすぐに変化を起こせるようになる

これが、CEOと[EBAチーム](/handbook/eba/)にとって、このプログラムが余分な経費をかけるだけの価値がある理由です。
...
今のところ、この役割を[CEOシャドウ](https://feld.com/archives/2015/03/ceo-shadowing.html)と呼び、なぜシャドウが会議に参加しているのかを外部の人に分かりやすくしています。

他の名称も検討。

1. テクニカルアシスタント：このタイトルは、[エグゼクティブアシスタント](/job-families/people-ops/executive-business-administrator/)の役割と混同される可能性があります。["2003年、ベゾス氏はジャッシー氏を技術アシスタントに抜擢した。その役割は、アマゾンCEOの毎週のミーティングをすべて補佐し、一種の参謀役として働くことだった。"](https://www.theinformation.com/articles/amazons-cloud-king-inside-the-world-of-andy-jassy).
1. CEOのチーフ・オブ・スタッフ：これは一般的に["サポート・スタッフのコーディネーター"](https://en.wikipedia.org/wiki/Chief_of_staff)ですが、この役割には頻繁にローテーションする人がいるので、この限りではありません。
1. [グローバルリーダーシップシャドウプログラム](https://www2.deloitte.com/gr/en/pages/careers/articles/leadership-shadow-program.html) CEOのシャドウイングだけでは長すぎる。
...
プログラムへの参加を検討されている方 過去のシャドウの体験談をお聞かせください。

1. [エリカ・リンドバーグの2日目](https://www.youtube.com/watch?v=xrWR0uU4nbQ)
1. [買収、成長曲線、IPO戦略：Khosla Venturesでの1日](/blog/2019/04/08/khosla-ventures-gitlab-meeting/)
1. [GitLab CEOシャドーアップデート - 2019年5月30日](https://www.youtube.com/embed/EfBMu9dTpno)
...
1. 上司を指定し、マージリクエストを承認してもらう（※ただし、マージはしない）。
1. 上司がマージ要求を承認したら、マージ要求を[CEO補佐官](/job-families/chief-executive-officer/chief-of-staff/) に割り当て、マージ要求を `#ceo-shadow` チャンネルにリンクし、メッセージでCEO補佐官の `@mention` をしてください。

CEOのスケジュールは流動的で常に変更される可能性があり、CEOシャドーのローテーションも常に変更される可能性があることを、日程を選択する際には留意してください。掲載された日程は保証されたものではありません。日程が重なった場合は、ローテーションを変更できるよう協力します。
...
CEO シャドウ・プログラムへの参加は任意であり、ご家庭に負担をかける可能性があることを理解しています。このような課題を克服し、保護者が柔軟に参加できるようにするため、「保護者向け」週としていくつかのローテーションを設定します。これは、シドが5日間の勤務のためにシャドウを必要としない週や、プログラムが分割され、週が連続しない週を指します。
...
多くの人にこのプログラムの恩恵を受けてもらいたいので、ローテーションを頻繁に行っています。
マネジメントのオーバーヘッドを軽くするために、新しく入ってくる人のトレーニングは重要です。
現在、2週間を1ローテーションとしています。

1. 1を参照し、出て行く人からトレーニングを受ける。
1. 1人を教える、自分が次期担当者を教育する。

シャドウは、2週間をフルに使ってください。

CEO が 1 週間以上の有給休暇を取る場合、あるいは [Contribute](/events/gitlab-contribute/) の期間中は、プログラムが一時停止し、1 人のシャドウが休み前に「1 人を見て」、休み後に「1 人を教える」ことになります。
一度に1週間以上家を空けることができない場合は、シャドウのいない1週間以上の休憩があるローテーションが最適です。

もし参加するために保育が必要な場合は、ギットラボがその費用を[払い戻し](/handbook/spending-company-money/)してくれます。

このプログラムは、GitLabの長期的なチームメンバーだけに限定されるものではありません。
新しいチームメンバーにとっては、私たちの[オンボーディング](/handbook/people-group/general-onboarding/)を完了した後に最初にすることかもしれません。
例外的なコミュニティ・メンバーも同様に参加できるかもしれません。
...
フォーマルな服装でなくても、ビジネスカジュアルな服装であれば問題ありません。例えば、Sidはボタンアップにジーンズを合わせることが多いです。GitLabのシャツは、社外での会議がないときに着ることができます。シドのカレンダーを見て、フォーマルな場があるかどうかを確認してください。もしわからない場合は、Slack の `#ceo-shadow` チャンネルで Executive Business Administrator (EBA) に尋ねてください。
街で会議があるときは、必ず歩きやすい靴でミッションコントロールにお越しください。歩きやすい服装で、たとえカレンダーにUberと書かれていても、Sidは歩くことを好みます。
...
送り出すシャドウは、入ってくるシャドウをトレーニングする責任があります。現在、[ceo-shadow](https://gitlab.com/gitlab-com/ceo-shadow)プロジェクトでオンボーディングとオフボーディングをトラッキングしています。

**次のことを確認してください。
 * **オンボーディング課題を作成する。** 入社するシャドウは、[`onboarding` テンプレート](https://gitlab.com/gitlab-com/ceo-shadow/onboarding/-/issues/new?issuable_template=onboarding) を使用して、プログラム開始前の金曜日までにオンボーディング課題を作成する責任があります。この課題は、入室するシャドウと退室するシャドウ（「ティーチングワン」となる人と自分）の両方に割り当ててください。
 * **オフボーディング課題を作成する** 2週目に[`offboarding`テンプレート](https://gitlab.com/gitlab-com/ceo-shadow/onboarding/-/issues/new?issuable_template=offboarding)を使って課題を作成します。
...
CEOシャドウとしての時間の目標を追加し、オンボーディング・イシューに追加することを検討します。目標をより実行可能なものにするために、[SMART goals framework](https://www.mindtools.com/pages/article/smart-goals.htm)を使用するとよいでしょう。

そうすることで、CEOシャドーの経験全体をより簡単に振り返ることができ、プログラム終了後に、より良いブログ記事を書くことができるかもしれません。

インスピレーションとして、オンボーディング・イシューに目標を追加したCEOシャドウの[例](https://gitlab.com/nmccorrison/ceo-shadow/-/issues/1#my-goals)を紹介します。
...
プログラム中に自分のことを聞かれるので、正しく説明することが大切です。そこで、鏡の前に立ち、3回ほど練習してください。ポイントは、自分の役割が「シドを追い回すこと」「CEOを追い回すこと」だと_言わないことです。このプログラムは、GitLabのあらゆる部分を探索し、学ぶためのものであり、そこに重点を置くべきものです。詳しくは [CEO シャドー紹介](#ceo-shadow-introductions) をご覧ください。
...
予定されているローテーションの前に、共同経営者とコーヒーチャットをする予定を立てるようにしましょう。これにより、彼らと知り合う機会が得られ、ローテーションに対する期待感を持つことができます。
...
#### CEOシャドウの卒業生とのコーヒーチャット

CEOシャドウの卒業生とコーヒーチャットをすることができます。CEO Shadow Alumni](/handbook/ceo/shadow/#alumni)のリストは以下から確認できます。このようなおしゃべりは、参加を申し込むかどうかを決めるときや、参加はできないがシャドー中の経験や卒業生が学んだことを聞いてみたいというときに役立ちます。
...
このセッションは、シャドウ・プログラム期間中の学習や観察についての質問に答えるためのものです。CEO シャドウとしてのあなたの時間を補足するために、私たちの [Chief Legal Officer (CLO)](/job-families/legal/chief-legal-officer/) は毎月シャドウチャットを開催しています。

次回のセッションに参加したい場合、または CLO と 1:1 のコーヒーチャットを予約したい場合は、`#ceo-shadow` に CLO の [Sr.EBA](/handbook/eba/#executive-business-administrator-team) を記入してください。このオプションは、過去、現在、未来のすべてのシャドウが利用できます。
...
CEO シャドウ・プログラム中の宿泊は、会社から提供されます。Executive Admin to the CEO が、空室状況と費用に基づいて宿泊先を予約します。希望（ホテルまたは AirBnB）は、当該 CEO の Executive Admin に電子メールで伝えることができます。ただし、CEOからの距離や費用を考慮し、最終的にはエグゼクティブ・アドミンが決定します。Executive Admin は、ローテーション予定日の 1 ヶ月前から 2 週間前までに、宿泊施設の詳細を提供します。

宿泊施設はシャドーイング期間中のみ提供され、シャドーイング休止期間中（CEOが不在の場合）には提供されません。
太平洋時間と6時間以上の時差がある地域から参加する場合、新しい時間帯に適応するために、最初のシャドーワークの前に週末を予約することが可能です。

CEOのシャドーローテーションが2週間連続の場合、週末に滞在することが想定されます。週末は宿泊施設が提供されます。
...
航空券は、当社の「トラベルポリシー」（/handbook/travel/#booking-travel and-lodging） または「会社のお金を使う」（/handbook/spending-company-money/）のポリシーに従って予約することができます。
シャドーローテーションにシャドーイングをしない時間が含まれる場合、米国本土内の往復航空券を経費とすることが可能です。また、アメリカ国外から参加する場合、サンフランシスコでの宿泊費が高額になる可能性があるため、シャドーイングを行わない期間の航空券を経費とすることも可能です。
...
サンフランシスコ国際空港（SFO）では、すべてのライドシェアアプリ（Uber、Lyftなど）が駐車場棟のレベル5でピックアップしています。他のShadows、GitLabチームメンバー、SidとSFOからMission Controlへの移動を調整する場合、各ターミナルに荷物受取所があるので、駐車場の5階で会うように手配するのが最も効率的である。
...
シャドウは、ローテーション中の飲食代を経費として計上することができますが、[会社のお金を使う](/handbook/spending-company-money/)ポリシーに従ってください。以前のシャドウは、自分の好きな食べ物屋さんの[おすすめリスト](/handbook/ceo/shadow/#recommended-fooddrinks-nearby)を作成し、参考にしています。
...
私たちの最優先事項はチームメンバーの健康と安全です。現行の[トラベルポリシー](/handbook/travel/#travel-guidance-covid-19)を参照してください。CEOシャドウ・プログラムは、非本質的な出張に分類され、リンク先のポリシーで指定されている期間中は、サンフランシスコへの出張は必要ではありません。このプログラムに参加するCEOシャドウは、遠隔地からプログラムに参加し、CEOが他のタイムゾーンに出張しない限り、主に太平洋タイムゾーンのCEOのスケジュールと一致するように計画してください。質問がある場合は、slack で `#ceo-shadow` を使用し、@ で [Staff EBA to the CEO](/handbook/eba/#executive-business-administrator-team) を指定してください。
...
## CEOシャドープログラムを始める他の企業への考慮点

GitLabの共同創業者でありCEOのSid Sijbrandijは、Sam Altmanからの[質問にYouTubeライブストリーム](https://youtu.be/ExG8_bnIAMI)で答え、2人は他の組織でCEOシャドープログラムを導入する際の注意点について議論しました。主な内容は以下の通りです。

1. CEOは、シャドウのために会議を最適化すべきではない。シャドウは、対面でもバーチャルでも、その場にいることで学んでいるのだから、すべてを完全に理解できなくても構わない。
1. 実際、シャドウは、メモを取ったり、要求に応じて会社ハンドブックの関連部分を変更したりすることで、CEOの一日を積極的に楽にする必要があります。
1. CEO（およびその組織）にとっての明白でない利点としては、CEOの共感と人間味の向上があり、チームメンバーがより快適に経営者に意見を提供できるようになります。シャドー卒業生が、プログラム参加時の[積極的な意思の表明](/handbook/values/#assume-positive-intent)の実例を直属の部下に伝え、企業文化をより強固なものにすることができる。
1. CEO シャドウは、普段の仕事を一切しないことを確認します。シャドーは、休暇を取るつもりでチームに準備をさせること。仕事量を確保しながら CEO のシャドウを行おうとすると、CEO シャドウに過度のストレスがかかります。
...
CEOシャドウプログラムの卒業生は、プログラム終了後も連絡を取り合うために、`#ceo-shadow-alumni`というSlackチャンネルに参加することを歓迎します。
