...
the AppSec engineer on [Triage (mentions and issues) Rotation](/handbook/security/security-engineering-and-research/application-security/runbooks/triage-rotation.html). This person should:
