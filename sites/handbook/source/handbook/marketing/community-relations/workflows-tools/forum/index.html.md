...
The moderation privilegues should only be used to pin topics or make (global) announcements. [Moderators](https://forum.gitlab.com/g/moderators) share different responsibilities, and categories. If you need help or guidance, please reach out in the `#community-relations` Slack channel. 
...
- Topics unrelated to GitLab, DevOps, etc. and text with many external URLs often is spam.
  - Take action with `Detete User > Delete and Block User`. This also deletes the post. 
- There are bots which copy the body text of another topic or reply, and create their own new topic with a new URL. Discourse detects them as `New user typed their first post suspiciously fast, suspected bot or spammer behavior.` 
  - Take action with `Detete User > Delete and Block User`.  
- False positives 
...
- A post was flagged as CoC violation. 
  ...
  - `Edit` the post and follow the [Code of Conduct Templates](/handbook/marketing/community-relations/workflows-tools/code-of-conduct-enforcement/#templates) to replace the text. 
...
- Violation of GitLab's [Code of Business Conduct & Ethics](/handbook/legal/gitlab-code-of-business-conduct-and-ethics/) and [Events Code of Conduct](/company/culture/ecoc/) (Ex. redacting swear words, if they are unable or unwilling to edit it themselves)
...
[Community response situations](/handbook/marketing/community-relations/developer-evangelism/community-response/#forum-topic-preparation) include preparing a forum topic as a draft in the [Internal](https://forum.gitlab.com/c/internal/) category.

Team members need to sign-up for a [forum account](/handbook/marketing/community-relations/workflows-tools/forum/#registration-and-login) in order to create a topic. The Internal category allows team members review and edit the draft together without it being available to the public. 
...
- Editing a topic description only is available for [trust level 4](/handbook/marketing/community-relations/workflows-tools/forum/#user-trust-levels) and moderators. Ask an administrator to update the [team member trust level](/handbook/marketing/community-relations/workflows-tools/forum/#team-member-trust-level) if necessary.  
...
Updates and important security fixes are applied by the Discourse team. [Technical owners](/handbook/marketing/community-relations/community-operations/#tooling) can reach out to their support team. For bussiness organization and subscription updates, please see [this internal issue](https://gitlab.com/gitlab-com/marketing/community-relations/community-operations/community-operations/-/issues/77).
...
- Trust level 3 as a regular user means becoming a GitLab community evangelist with visiting often, leading the path with helpful responses, enaging with likes and feeling energized.
...
Please open an issue in the [community operations tracker](https://gitlab.com/gitlab-com/marketing/community-relations/community-operations/community-operations/-/issues/new) and share the user profile URL and a detailed reason why they should be promoted to trust level 4. Assign the issue to technical owners using this quick action: `/assign @dnsmichi @sugaroverflow @greg`. Administrators will review and reach out to nominated community members. 

##### Team Member Trust Level

GitLab team members who signup using oauth, will automatically be added to the `gitlab-team` group, granting [trust level 3](/handbook/marketing/community-relations/workflows-tools/forum/#user-trust-levels). This group does not trigger any @-mention notifications in forum posts. 

Administrators can promote team members to trust level 4 manually, for example when needed for [community response workflows](/handbook/marketing/community-relations/workflows-tools/forum/#forum-community-response-workflow). 
...
- [Internal](https://forum.gitlab.com/c/internal/) is required for the [community response workflow](/handbook/marketing/community-relations/workflows-tools/forum/#forum-community-response-workflow)
...
Administrators can modify the [Discourse settings](https://forum.gitlab.com/admin/site_settings/category/all_results). Please [open a new issue](https://gitlab.com/gitlab-com/marketing/community-relations/community-operations/community-operations/-/issues) to suggest, discuss and document changes. 
...
- Login: GH login, oauth2 enabled (GitLab oauth)
...
[Forum Spelunker](https://forum.gitlab.com/admin/badges/104) is a custom badge which was granted to everyone helping answer and solve old forum topics in May 2020. 
...
1. Create a [new issue](https://gitlab.com/gitlab-com/marketing/community-relations/community-operations/community-operations/-/issues) to propose changes, including design mockups, screenshots, etc. 
1. Apply the changes to the custom theme, colors, etc. 
1. Persist the changes for the custom theme in the [discourse-assets](https://gitlab.com/gitlab-com/marketing/community-relations/community-operations/discourse-assets) project.

#### API

Used by integrations, such as the [GitLab Blog Bot](/handbook/marketing/community-relations/workflows-tools/zapier/#gitlab-blog-forum-bot).
...
Create a new [issue in teh community operations project](https://gitlab.com/gitlab-com/marketing/community-relations/community-operations/community-operations/-/issues) to document changes in settings, handle abusive behaviour and other administrative tasks. 
