...
1. **Qualifying Accounts:**
    ...
    1. SALs/AEs should not be selling into accounts they do not own. Two policies apply to prevent this behavior:
        1. **Chalk the Line** applies to when an Account is accurately aligned to the correct segment and owner at the beginning of the year based on employee count. During the year, if there is an increase or decrease to employee count, the Account will NOT be moved to a new segment or owner. 
